    ...
    <section class="container bg-yellow">
        ...
        <div id="products-section" class="row">
            ...
            <div class="col d-flex">
                <div class="">
                    {{-- Cycle foreach to print all the products of the rsestaurant --}}
            ...
            {{-- Cart section --}}
            <div v-if="cart.length > 0" class="cart bg-white cart d-flex" >
                <div id="cart-section" class="col  justify-content-center" style="width: 30rem;" v-if="cart[0].user_id == {{ $user->id }}">
